...
export const questionSet2 = {
  ...
  questions: ['How would performance change if you are more aware of how your time is spent?', 'What system can you implement to help you achieve that?'],
};
export const questionSet3 = {
  ...
  questions: ['What is already working in your system that you can build on?', 'What might "help" look like?'],
};
export const questionSet4 = {
  ...
  questions: ['In the beginning, how did you want it to be?', 'What is the best/worst thing that could happen if you continue this way?', 'What might "help" look like?', 'How can you make yourself accountable?'],
};
